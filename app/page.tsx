  ...
  return (
    <div className="min-h-screen bg-slate-50 font-sans">
      ...
      <section className="relative h-[500px] md:h-[650px] w-full overflow-hidden bg-gray-900">
        ...
        {/* Hero Content */}
        <div className="absolute inset-0 flex items-center justify-center text-center z-20 px-4 pointer-events-none">
          <div className="max-w-5xl space-y-6 md:space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-1000 pointer-events-auto">
            ...
            <p className="text-base md:text-2xl text-gray-200 max-w-3xl mx-auto font-light tracking-wide drop-shadow-md leading-relaxed px-2">
              ...
              <br className="hidden md:block" /> Shaping the future of
            ...
            <div className="flex flex-col sm:flex-row gap-4 sm:gap-5 justify-center pt-4 md:pt-8 px-4">
              <Button
                asChild
                size="lg"
                className="bg-blue-600 hover:bg-blue-500 text-white px-8 md:px-10 py-6 md:py-7 text-base md:text-lg font-semibold shadow-blue-900/50 shadow-lg transition-all hover:scale-105"
              >
              ...
              <Button
                ...
                size="lg"
                variant="outline"
                className="border-2 border-white/30 text-white bg-white/5 hover:bg-white hover:text-blue-900 px-8 md:px-10 py-6 md:py-7 text-base md:text-lg font-semibold backdrop-blur-sm transition-all hover:scale-105"
              >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16 md:mb-20">
            ...
            <p className="mt-4 text-gray-600 max-w-2xl mx-auto">
              Everything you need to build a successful career in healthcare.
            </p>
          </div>
            ...
            {[
              ...
              <Link key={idx} href={item.link} className="group h-full block">
                <Card className="h-full border-0 shadow-lg hover:shadow-2xl transition-all duration-300 bg-white hover:-translate-y-2 overflow-hidden">
                  <div
                    className={`h-2 w-full ${item.bg
                      .replace("bg-", "bg-")
                      .replace("50", "500")}`}
                  ></div>
                  <CardContent className="p-8 flex flex-col items-center text-center h-full">
                    <div
                      className={`w-20 h-20 ${item.bg} rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300`}
                    >
                    ...
                    <span
                      className={`font-bold text-sm uppercase tracking-wider flex items-center justify-center gap-2 ${item.color} group-hover:gap-3 transition-all`}
                    >
            ...
            {[
              {
                ...
                desc: "Hands-on experience in top affiliated hospitals.",
              },
              {
                icon: GraduationCap,
                title: "Expert Faculty",
                desc: "Learn from industry veterans and medical experts.",
              },
              {
                icon: Heart,
                title: "Holistic Growth",
                desc: "Focus on professional ethics, values & character.",
              },
              {
                icon: Award,
                title: "100% Placement",
                desc: "Career guidance and placement support for all.",
              },
            ].map((item, idx) => (
              <div
                key={idx}
                className="relative p-8 rounded-2xl border border-gray-100 hover:border-blue-200 hover:shadow-xl transition-all duration-300 group hover:bg-blue-50/30"
              >
      ...
      <section className="py-16 md:py-24 bg-blue-900 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 text-center relative z-10">
          ...
          <p className="text-blue-100 mb-10 text-lg md:text-xl font-light max-w-2xl mx-auto">
            ...
            open for the 2024-25 academic session.
          </p>
