    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <section className={`relative bg-gradient-to-br ${c.hero} pt-10 pb-16 overflow-hidden transition-all duration-300`}>
        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              <p className={`${c.accent} text-xs font-bold uppercase tracking-[0.2em] mb-1`}>Exam Preparation</p>
          ...
          <p className="text-white/70 text-base max-w-2xl mb-8">
            Year-wise question banks for GNM students. Select a year to view and download subject papers.
          </p>
          {/* Year Tabs */}
      ...
      <div className="bg-white border-b border-slate-100">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-3 flex items-center gap-2 text-xs text-slate-400">
          ...
          <ChevronRight className="h-3 w-3" />
          <Link href="/resources/question-banks" className="hover:text-blue-600 transition-colors">Question Banks</Link>
          <ChevronRight className="h-3 w-3" />
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          {current.papers.map((paper, index) => (
            ...
            >
              <div className="p-6 flex flex-col h-full">
                ...
                <p className="text-xs text-slate-400 mb-4">{current.label} · Question Bank</p>
                <a
                  href={paper.link}
                  target="_blank"
        ...
        <div className="mt-8 p-6 bg-emerald-50 border border-emerald-100 rounded-2xl text-sm text-emerald-800">
