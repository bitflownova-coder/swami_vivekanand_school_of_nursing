      ...
      <div className="relative bg-blue-900 text-white py-24 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center z-10">
          ...
          <p className="text-xl text-blue-100 max-w-2xl mx-auto leading-relaxed mb-10 font-light">
            Join Swami Vivekanand School of Nursing GNM. Empowering the next
            generation of healthcare leaders with compassion, skill, and
            excellence.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button
              size="lg"
              className="bg-white text-blue-900 hover:bg-blue-50 px-8 py-6 text-lg font-semibold shadow-lg hover:shadow-xl transition-all"
            >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-16 relative z-20 mb-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          {[
            ...
            <Card
              key={index}
              className={`text-center border-t-4 ${stat.border} hover:-translate-y-1 hover:shadow-xl transition-all duration-300 bg-white`}
            >
              <CardContent className="pt-8 pb-6">
                <stat.icon
                  className={`h-10 w-10 ${stat.color} mx-auto mb-3 opacity-90`}
                />
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <Card className="group hover:shadow-xl transition-all duration-300 border-0 bg-white shadow-md">
              <CardContent className="pt-10 pb-8 px-8">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Extensive hands-on practical experience in affiliated
                  multi-specialty hospitals to ensure real-world readiness.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="group hover:shadow-xl transition-all duration-300 border-0 bg-white shadow-md">
              <CardContent className="pt-10 pb-8 px-8">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Learn from a dedicated team of experienced nursing
                  professionals and medical experts committed to your success.
                </p>
              </CardContent>
            </Card>
          </div>
              ...
              <div className="flex flex-col md:flex-row items-center justify-between gap-4">
                <div>
                  ...
                  <p className="text-gray-400 mt-2 ml-1">
                    Academic Years 2023-25 • GNM Program
                  </p>
                </div>
            ...
            <CardContent className="p-0">
              <div className="overflow-x-auto">
                <table className="w-full text-sm text-left">
                  <thead className="text-xs text-gray-700 uppercase bg-gray-50 border-b">
                    <tr>
                      <th className="px-6 py-4 font-extrabold text-gray-900">
                        Sr. No.
                      </th>
                      <th className="px-6 py-4 font-extrabold text-gray-900">
                        Course
                      ...
                      <th className="px-6 py-4 font-extrabold text-gray-900 text-right">
                        Development
                      </th>
                      <th className="px-6 py-4 font-extrabold text-gray-900 text-right">
                        Tuition
                      </th>
                      <th className="px-6 py-4 font-extrabold text-gray-900 text-right bg-blue-50/50">
                        Total
                      </th>
                    </tr>
                  </thead>
                  <tbody className="divide-y divide-gray-100">
                    <tr className="bg-white hover:bg-gray-50 transition-colors">
                      ...
                      <td className="px-6 py-4 font-bold text-blue-600">GNM</td>
                      ...
                      <td className="px-6 py-4 text-right font-mono font-bold text-lg text-blue-600 bg-blue-50/30">
                        ₹50,000
                      </td>
                    </tr>
                    <tr className="bg-white hover:bg-gray-50 transition-colors">
              ...
              <div className="bg-yellow-50/50 p-6 border-t border-yellow-100">
                <div className="flex gap-4">
                  ...
                  <div>
                    <h4 className="font-bold text-yellow-900 text-sm uppercase tracking-wide mb-2">
                      Fee Guidelines
                    </h4>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-2 text-sm text-yellow-800/80">
                      ...
                      <p>
                        • Additional fees for hostel, uniform & exams apply.
                      </p>
                      <p>• Fees subject to government revision.</p>
                      <p>
                        • Scholarship options available for eligible students.
                      </p>
                    </div>
                  </div>
                </div>
                  ...
                  <div>
                    ...
                    <ul className="space-y-3 pl-10">
                      ...
                      <li className="flex items-start gap-3 text-gray-600">
                        <div className="h-1.5 w-1.5 rounded-full bg-blue-500 mt-2 flex-shrink-0"></div>
                        <span>
                          Minimum <strong>40% aggregate marks</strong> in the
                ...
                <div className="relative border-l border-blue-700 ml-3 space-y-8 py-2">
                  {[
                    ...
                    <div key={i} className="relative pl-8">
                      <div
                        className={`absolute -left-[5px] top-1.5 h-2.5 w-2.5 rounded-full ${item.color} ring-4 ring-blue-900`}
                      ></div>
                      <p className="text-blue-300 text-xs uppercase tracking-wider font-bold">
                        {item.label}
                      </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              {[
                ...
                { step: "03", title: "Verify", desc: "Document verification" },
                {
                  step: "04",
                  title: "Pay Fee",
                  desc: "Confirm your admission",
                },
              ].map((item, i) => (
                <div
                  key={i}
                  className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 text-center hover:shadow-md transition-shadow relative"
                >
          ...
          <CardContent className="p-12 md:p-16 text-center relative">
            ...
            <div className="relative z-10 max-w-3xl mx-auto">
              ...
              <p className="text-lg md:text-xl text-blue-100 mb-10">
                Don&apos;t miss the opportunity to study at one of
                Maharashtra&apos;s premier nursing institutes. Limited seats
                available for the upcoming session.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Button
                  size="lg"
                  className="bg-white text-blue-600 hover:bg-gray-100 px-10 py-7 text-lg font-bold shadow-xl"
                >
                  Begin Application
                </Button>
                <Button
                  size="lg"
                  variant="outline"
                  className="border-2 border-white text-blue-600 hover:bg-white/10 px-10 py-7 text-lg font-bold"
                >
                  Contact Support
                </Button>
              </div>
